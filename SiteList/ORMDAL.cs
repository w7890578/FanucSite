    ...
    internal static Database Read
    {
        get
        {
            if (_read == null)
            {
                lock (_readLock)
                {
                    return _read ?? (_read = DatabaseFactory.CreateDatabase("Company_Reader"));
                }
            }
            return _read;
        }
    ...
    internal static Database Write
    {
        get
        {
            if (_write == null)
            {
                lock (_writeLock)
                {
                    return _write ?? (_write = DatabaseFactory.CreateDatabase("Company_Reader"));
                }
            }
            return _write;
        }
    ...
    internal static Database Admin
    {
        get
        {
            if (_admin == null)
            {
                lock (_adminLock)
                {
                    return _admin ?? (_admin = DatabaseFactory.CreateDatabase("Company_Reader"));
                }
            }
            return _admin;
        }
