...
{
    public class GCodeController : BaseController
    {
        /// <summary>
        /// 第一次访问
        /// </summary> 
        ...
        [HttpPost]
        public JsonResult Query(GCodeView entity)
        {
            entity.CurrentPage = new PageNation<GCodeView>()
            {
        ...
        /// <returns>Json字符串</returns>
        [HttpPost]
        public JsonResult Get_Details(GCodeView entity)
        {
            entity.Get_Detail();
        ...
        [HttpPost]
        public ContentResult Delete(GCode entity)
        {
            bool result = GCodeBLL.Instance.Where("ID=@ID").Parms(entity.ID)
                .Update("IsDel=1");
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ContentResult Save(GCode entity)
        {
            bool result = false;
            if (!string.IsNullOrEmpty(entity.ID)) //编辑
            {
                entity.UpdateTime = DateTime.Now;
                result = GCodeBLL.Instance.Update(entity,
              new string[] {  
                         "CodeNumber",
                         "FunctionDescription",
                         "Content",
            ...
            {
                object ob = GCodeBLL.Instance.Add(entity,
                new string[] { 
                         "CodeNumber",
                         "FunctionDescription",
                         "Content",
